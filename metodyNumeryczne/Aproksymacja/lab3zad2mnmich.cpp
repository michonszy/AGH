...
int main()
{
    ...
    tab[0][0] = 1; tab[0][1] = 3;
    tab[1][0] = 3; tab[1][1] = 4;
    tab[2][0] = 4; tab[2][1] = 11;
    tab[3][0] = 7; tab[3][1] = 10;
    tab[4][0] = 9; tab[4][1] = 11;
    tab[5][0] = 13; tab[5][1] = 10;
    tab[6][0] = 14; tab[6][1] = 8;
    tab[7][0] = 16; tab[7][1] = 6;
    

    //zdefiniowanie wartości, w przypadku zmiany m nalezy rowniez zwiekszyc o 1 kazda wartosc w macierz1 i w tablicy x
    float m = 1;
    float macierz1[2][3];
    float x[2];
