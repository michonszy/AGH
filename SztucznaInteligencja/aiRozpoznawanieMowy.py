...
# Pobierz i wyodrębnij plik mini_speech_commands.zip zawierający  zestawy danych poleceń mowy za pomocą tf.keras.utils.get_file
...
#Podziel ścieżki plików na tf.RaggedTensor s (tensory o poszarpanych wymiarach — z plastrami, które mogą mieć różne długości).
...
#Utwórz tf.data.Dataset z Dataset.from_tensor_slices i Dataset.map , używając wcześniej zdefiniowanych funkcji get_waveform_and_label .
